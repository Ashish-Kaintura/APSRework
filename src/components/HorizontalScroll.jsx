...
const slides = [
    {
        id: 1, title: "Man Guarding", subtitle: "AP Securitas was incorporated in 1986  has offices across length & amp; breadth of the country.", img: service1
    },
    { id: 2, title: "Survelliance", subtitle: "Surveillance subtitle", img: service2 },
    { id: 3, title: "Traning", subtitle: "training subtitle. ", img: service3 },
    { id: 4, title: "Facility management ", subtitle: "Facility management subtitle. ", img: service4 },
];
...
const HorizontalScroll = () => {
    ...
    return (
        <section ref={container} className="relative h-screen bg-[#b0b0b0] text-[#1a1a1a] overflow-hidden">
            <div className="absolute top-8 left-12 z-10 ">
                <h3 className="text-sm uppercase tracking-widest border-b border-black pb-2">Main services</h3>
                <p className='text-2xl font-sans font-semibold'>Leaders in Security, <span className='font-sans text-primary'> Electronic <br /> Surveillance and Facility Management. </span></p>
            </div>
            ...
            <div ref={slider}
                ...
                {slides.map((slide) => (
                    <div key={slide.id} className="panel w-screen h-full flex items-center justify-center p-24 flex-shrink-0 relative">

                        {/* Split Layout */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-full h-full items-center">
                            {/* Image Side */}
                            <div className="h-[60vh] overflow-hidden relative group">
                                <img
                                    src={slide.img}
                                    alt={slide.title}
                            ...
                            <div className="space-y-4">
                                <span className="text-9xl opacity-10 font-bold absolute top-20 right-20 pointer-events-none serif">0{slide.id}</span>
                                <h2 className="text-6xl md:text-8xl serif tracking-tighter">{slide.title}</h2>
